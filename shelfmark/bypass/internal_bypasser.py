...
class _WaitingRoomTimeoutError(TimeoutError):
    """Anna's waiting room did not finish within this browser session's budget."""
...
async def _wait_for_aa_download_page(
    ...
    try:
        ...
        raise _WaitingRoomTimeoutError(
            "Anna's Archive waiting room did not finish within 300s"
        ) from exc
        ...
        try:
            ...
            for attempt in range(retry):
                ...
                try:
                    ...
                    raise
                except _WaitingRoomTimeoutError as exc:
                    # Retrying with a new browser would restart the same queue again.
